...
function expectedBasicAuthOptionsResult(): AuthResolution {
    return {
...
suite('registry-auth-config', function () {
    suite('registry urls and base options', function () {
    ...
    suite('auth option building', function () {
    ...
    suite('publish and metadata auth', function () {
        ...
        test('resolveMetadataAuthOptions keeps npm-oidc metadata inheritance anonymous when explicitly requested', function () {
            assert.deepStrictEqual(
                resolveMetadataAuthOptions({
                    auth: { publish: { type: 'npm-oidc' }, metadata: 'inherit-publish-auth' }
                }),
                {
                    allowsAutomaticRetry: false,
                    registry: undefined,
    ...
    suite('stage listing auth', function () {
