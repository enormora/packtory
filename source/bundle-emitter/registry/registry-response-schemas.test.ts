...
suite('registry-response-schemas', function () {
    ...
    suite('OIDC exchange responses', function () {
        ...
        test('parseOidcExchangeResponse reports a stable issue for non-object responses', function () {
            for (const response of [ null, [], 'token' ]) {
