...
type Overrides = {
    readonly fileExists?: SinonSpy;
    readonly fileExistsSync?: SinonSpy;
    readonly directoryExists?: SinonSpy;
    readonly directoryExistsSync?: SinonSpy;
    readonly readFile?: SinonSpy;
    readonly readFileSync?: SinonSpy;
};
...
type WrappedFileHostMethodCallTestCase = {
    readonly method: 'directoryExists' | 'directoryExistsSync' | 'fileExists' | 'fileExistsSync';
    readonly adapter: 'fileSystemHostFilteringDeclarationFiles' | 'fileSystemHostWithoutFilter';
    readonly pathToCheck: string;
    readonly upstreamMethodReturnValue: boolean;
    readonly expectedResult: boolean;
    readonly expectedUpstreamCalls: readonly unknown[];
};
...
suite('typescript-file-host', function () {
    suite('filtering', function () {
        ...
        suite('directory existence', function () {
            test(
        ...
        suite('unfiltered file existence', function () {
            test(
    ...
    suite('sync validation', function () {
    ...
    suite('unfiltered host', function () {
        test(
    ...
    suite('type roots filtering', function () {
        test(
    ...
    suite('virtual package json', function () {
