...
type Overrides = {
    readonly topLevelDependencies?: readonly string[];
...
function collectVisitorNodes(graph: DependencyGraph, startFilePath: string): readonly DependencyNode[] {
    ...
    graph.walk(startFilePath, function (node) {
        collected.push(node);
    });
...
suite('dependency-graph', function () {
    suite('nodes and connections', function () {
