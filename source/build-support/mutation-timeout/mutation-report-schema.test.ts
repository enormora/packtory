...
suite('mutation-report-schema', function () {
    suite('invalid report shapes', function () {
    ...
    suite('invalid mutants', function () {
    ...
    test('parseMutationReport preserves a valid mutant with status, static flag, and location', function () {
        assert.deepStrictEqual(
            parseMutationReport({
                files: {
                    'source/a.ts': {
            ...
            }),
            {
                files: {
                    'source/a.ts': {
                        mutants: [
                            { status: 'Timeout', static: false, location: { start: { line: 3, column: 4 } } },
                            { status: 'Timeout', static: true, location: { start: { line: 5, column: 6 } } }
                        ]
                    }
                }
            }
