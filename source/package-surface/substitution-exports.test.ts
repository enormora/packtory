...
suite('substitution-exports', function () {
    suite('basic substitutions', function () {
    ...
    suite('declaration companions', function () {
    ...
    suite('ignored substitutions', function () {
    ...
    suite('error and duplicate handling', function () {
